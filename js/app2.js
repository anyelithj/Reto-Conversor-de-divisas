...
function addValue(e) {
    ...
    result.value = valueEntry;
    result.textContent = valueEntry; */

    //resultSelect.appendChild(result);
    if( valueEntry === '' || isNaN(valueEntry) || valueEntry <= 0 ) {
        resultado = 'El valor no es valido';
        console.log(resultado);
        //console.log('El valor no es valido')
       //printMessage('El valor no es valido', 'error');
   } 
     moneysSelectOne = moneysSelectOne.value;
     //moneysSelect = moneysSelect.value;
